...
std::string readFileFunc() {
	...
	hFile = CreateFile(CONFIGFILE,               // file to open
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
//// HTTP functiion for http communication  /////
/////////////////////////////////////////////////
////////////////////////////////////////////////////
std::string sendRequest(std::string user, std::string workstation) {
	...
	reqConfig["user"] = user;
	reqConfig["workstation"] = workstation;
	...
	if (hSession)
	{
		...
		if (hConnect)
		{
			hRequest = WinHttpOpenRequest(hConnect, L"POST", L"/api/v1/remote/auth/win",
				NULL, WINHTTP_NO_REFERER,
				WINHTTP_DEFAULT_ACCEPT_TYPES,
				NULL); //WINHTTP_FLAG_SECURE, NULL);
		}
		else {
			return mockstatus;
		}
