...
//for json
// #include <\Users\BAT\vcpkg\installed\x86-windows\include\nlohmann\json.hpp>
// using json = nlohmann::json;
#include <nlohmann/json.hpp>
using json = nlohmann::json;

//WriteLogFile(ptr);
#define LOGFILE L"C:\\filterlog.txt"
...
BOOL WriteLogFile(LPWSTR Stringval)
{
	...
	//WriteFile(hFile, Stringval, 200, &dwBytesWritten, NULL);
...
#define CONFIGFILE L"C:\\Program Files\\TrasaCPFilter\\config.dat"
...
std::string readFileFunc() {
	...
	std::string filePath = "C:\\Program Files\\TrasaCPFilter\\config.dat";
