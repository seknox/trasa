...
export const CreatePolicy = () => {
  beforeAll(async () => {
    await page.goto(Constants.TRASA_DASHBOARD + "/policies", {
      waitUntil: "load",
    });
  });

  it(
    "Should Create a new policy " + Constants.TRASA_DASHBOARD + "/policies",
    async () => {
      ...
      const navPromise = page.waitForResponse((r) =>
        r.url().includes("policy/create")
      );
      ...
      await page.waitForSelector('[id="' + testPolicy.name + '"]', {
        timeout: 5000,
      });
