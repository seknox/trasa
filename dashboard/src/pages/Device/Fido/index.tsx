...
export function StartTimeout(
  ...
  TimeoutFn = setTimeout(() => {
    ...
    const percent = Math.floor((left / total) * 100);
    if (percent > 0) {
      setTimeoutProp(percent);
      StartTimeout(timeout, start, total, setTimeoutProp);
    } else {
      setTimeoutProp(0);
    }
  }, 1000);
...
export function StopTimeout(setTimeoutProp: (v: number) => void) {
  setTimeoutProp(0);
  clearTimeout(TimeoutFn);
}

export default function FidoU2f() {
            ...
            <Grid container spacing={2} direction="column" alignItems="center" justify="center">
              <Grid item xs={12}>
                <Typography component="h3" variant="h1">
                  <b>Register you Security Token.</b>
                </Typography>
              </Grid>
