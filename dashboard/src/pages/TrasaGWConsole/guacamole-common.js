...
Guacamole.Client = function(tunnel) {
    ...
    /**
     * Send totp code in response to "asktfa"
     *
     * @param {String} totp  The totp code to send. (Blank for u2f)
     * */
    this.sendtfa=function (totp) {
        tunnel.sendMessage("tfa",totp)
    }
    ...
    /**
     * @bhrg3se
     * This is custum function added to support TRASA 2fa.
     * When password is correct. and  second factor authentication is needed. proxy server will send "asktfa" opcode to ask for tfa method
     *
     * Code to display tfa method page should be displayed with function
     *
     * */
    this.onasktfa=null//function () {}
 ...
 */
Guacamole.Tunnel = function(tunnelURL) {
