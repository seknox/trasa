...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'Rajdhani-Regular' : 'Rajdhani-Regular',
  ...
  checkboxBgColor: '#0e0343',
  checkboxSize: 20,
  checkboxTickColor: '#fff',

  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#0e0343' : '#0e0343',
  brandInfo: '#62B1F6',
  brandSuccess: '#146907',
  brandDanger: '#d20000',
  brandWarning: '#f0ad4e',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'Rajdhani-SemiBold' : 'Rajdhani-SemiBold',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#0e0343' : '#0e0343',
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#0e0343' : '#0e0343',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#fff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#0e0343' : '#0e0343',//#0e0343
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'Rajdhani-Regular' : 'Rajdhani-Regular',
